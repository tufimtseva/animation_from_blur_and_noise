...
img = imfrombytes(img_bytes, float32=True)        # numpy array HWC, float32
img = img2tensor(img, bgr2rgb=True, float32=True)  # CHW, float32
img = img.unsqueeze(0).to(opt['device'])          # add batch dim
